      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200">
          <Link to="/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-hunter-600">CounselorReady</span>
          </Link>
          <button 
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-hunter-100 flex items-center justify-center">
        ...
        <header className="sticky top-0 z-30 h-16 bg-white border-b border-gray-200 flex items-center px-4 lg:px-8">
          ...
          {user?.subscription?.status === 'trial' && (
            <div className="ml-auto flex items-center gap-2 text-sm">
              ...
              <Link to="/settings" className="text-hunter-600 hover:text-hunter-700 flex items-center gap-1">
