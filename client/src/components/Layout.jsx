...
import { Menu, X, ChevronDown, LogOut, Settings, ShieldCheck, Trophy, Users, Star, ClipboardList, MoreHorizontal, Bell, Lock, FileText } from 'lucide-react';
...
const moreLinks = [
  ...
  { name: 'Doc Viewer',       href: '/file-viewer',          icon: FileText },
];
