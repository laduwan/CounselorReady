        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg card-hover hover:shadow-xl relative border-2" style={{ borderColor: '#D4A855' }}>
              ...
              <ul className="space-y-3 mb-8 text-sm">
                {['Specialty credential tracking (BC-TMH, CPCS, etc.)', 'Certification courses (Grief, Anger Mgmt, etc.)', 'AI Note Writer & Treatment Planner', '1 synchronous CE hour earned quarterly'].map(f => (
                  <li key={f} className="flex items-start gap-2" style={{ color: '#355E3B' }}>
            ...
            <div className="relative rounded-2xl p-6 text-white shadow-2xl card-hover overflow-hidden" style={{ background: '#6B1D34' }}>
              ...
              <div className="relative z-10">
                <div className="font-medium uppercase text-sm tracking-wide mb-3" style={{ color: '#D4A855' }}>Annual</div>
                <div className="flex items-baseline gap-1 mb-2">
                  <span style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '2.5rem', fontWeight: 600 }}>$249</span>
                  <span className="font-light" style={{ color: '#f5d0d6' }}>/yr</span>
                </div>
                <p className="text-xs mb-4" style={{ color: '#f5d0d6' }}>Everything in Professional, plus:</p>
                <ul className="space-y-3 mb-8 text-sm">
                  {['Synchronous workshops (up to 15 hrs)', 'PassReady Prep discount for you & family', 'Group office hours quarterly', 'Rate lock guarantee', '1 hardship month/year (rolls over)'].map(f => (
                ...
                <Link to="/register?plan=annual" className="block text-center w-full py-3 font-bold rounded-xl transition-all text-sm hover:opacity-90" style={{ background: '#D4A855', color: '#4a1524' }}>
                  Go Annual
                </Link>
              </div>
            </div>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px 28px', fontFamily: "'Lato', Calibri, sans-serif" }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'flex-start', marginBottom: 28 }}>
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
              ...
              <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 13, color: '#D4A855', letterSpacing: '0.15em', fontWeight: 500, marginBottom: 12 }}>LEARN. LICENSE. LEAD.&#8482;</div>
              <p style={{ fontSize: 12, lineHeight: 1.7, color: 'rgba(255,255,255,0.75)', maxWidth: 280, margin: 0 }}>
                The continuing education platform built by a counselor, for counselors. Track credentials, complete courses, stay audit-ready.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, flex: 1, minWidth: 200, justifyContent: 'flex-end' }}>
              <div>
                ...
                {[
                  ...
                  ['/research-ready.html', 'Researched-N-Ready'],
                  ['/credentials.html', 'Credentials'],
                  ['/credentials.html#certifications', 'CE certificates'],
                ].map(([href, label]) => (
                  <a key={label} href={href} style={{ display: 'block', fontSize: 12, color: 'rgba(255,255,255,0.75)', textDecoration: 'none', padding: '3px 0' }}>{label}</a>
                ))}
              </div>
              <div>
                <h4 style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#D4A855', margin: '0 0 10px' }}>Support</h4>
                {[
                  ['/help.html', 'Help center'],
                  ['/blog.html', 'Blog'],
                  ['mailto:support@counselorready.com', 'Contact us'],
                  ['/about.html', 'About'],
                ].map(([href, label]) => (
                  <a key={label} href={href} style={{ display: 'block', fontSize: 12, color: 'rgba(255,255,255,0.75)', textDecoration: 'none', padding: '3px 0' }}>{label}</a>
                ))}
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
              {[
                ...
                ['/ada-accommodations.html', 'ADA Accommodations'],
                ['/non-discrimination.html', 'Non-Discrimination'],
                ['/complaint-resolution.html', 'Complaints'],
              ].map(([href, label]) => (
                <a key={label} href={href} style={{ fontSize: 11, color: 'rgba(255,255,255,0.45)', textDecoration: 'none' }}>{label}</a>
              ))}
            </div>
          </div>
        </div>
