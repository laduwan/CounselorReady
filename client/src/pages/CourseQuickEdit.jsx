...
const CourseQuickEdit = () => {
  ...
  return (
    <div>
      ...
      <h2 className="font-display text-xl font-semibold text-navy-600 mb-3">All Courses</h2>
              ...
              <div key={course._id} className="bg-white rounded-xl shadow-sm border border-forest-100 overflow-hidden">
                ...
                {isExpanded && (
                  <div className="border-t border-forest-100 p-5 space-y-4">
                    <h3 className="font-display text-lg font-semibold text-navy-600">Edit Details</h3>
                    {/* Description */}
                    <div>
