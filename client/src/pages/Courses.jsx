    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-forest-600">Build your clinical skills with practical training</p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                filter === tab.id
                  ...
                  : 'text-forest-600 hover:text-navy-600'
              }`}
            >
              {tab.label}
            </button>
    ...
    <div className="card flex flex-col hover:shadow-md transition-shadow">
      ...
      <div className="flex-1">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3 className="font-semibold text-navy-600 line-clamp-2">{course.title}</h3>
          {isFree && (
            <span className="px-2 py-0.5 bg-hunter-100 text-hunter-700 text-xs font-medium rounded-full flex-shrink-0">
              Free
            </span>
          )}
        </div>
        ...
        {course.subtitle && (
          <p className="text-sm text-forest-500 mb-3">{course.subtitle}</p>
        )}
        ...
        {isEnrolled && (
          <div className="mb-4">
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-burgundy-700 font-medium">{course.enrollment.percentComplete}%</span>
            </div>
