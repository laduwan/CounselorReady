  ...
  return (
    <div className="p-4 border-t border-[#DDD9D3]">
      {Object.entries(articles).map(([category, { articles: arts, deficit }]) => (
        <div key={category} className="mb-4 bg-[#FAF5EC] border border-[#DDD9D3] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            <Beaker className="w-4 h-4 text-[#8B5E2E]" />
            <h3 className="font-[Georgia,serif] text-sm font-semibold text-[#8B5E2E]">
              Researched-N-Ready: Fill Your Gap — {category}
            </h3>
          </div>
