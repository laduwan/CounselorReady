      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
              settings.emailReminders ? 'bg-forest-600' : 'bg-gray-200'
            }`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
              settings.marketingEmails ? 'bg-forest-600' : 'bg-gray-200'
            }`}
          >
            <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
      ...
      <div className="card">
        ...
        {!hasSubscription && (
          <div className="bg-burgundy-100 rounded-lg p-4 mb-6">
            <h3 className="font-medium text-burgundy-800 mb-2">Upgrade to Pro</h3>
            <ul className="space-y-2 text-sm text-forest-700 mb-4">
