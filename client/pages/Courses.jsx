...
function CourseCard({ course, hasSubscription }) {
  ...
  return (
    <div className="card flex flex-col hover:shadow-md transition-shadow">
      {/* Course image/icon */}
      <div className="h-40 bg-gradient-to-br from-forest-100 to-forest-200 rounded-lg mb-4 flex items-center justify-center">
        <BookOpen className="w-12 h-12 text-forest-600" />
      </div>
        ...
        {isEnrolled && (
          <div className="mb-4">
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-forest-600 font-medium">{course.enrollment.percentComplete}%</span>
            </div>
