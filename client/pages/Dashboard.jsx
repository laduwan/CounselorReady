  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="card">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-honey-400 bg-opacity-20 rounded-lg flex items-center justify-center">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/courses" className="text-forest-600 hover:text-forest-700 text-sm font-medium flex items-center gap-1">
            ...
            <div className="space-y-3">
              {courses.slice(0, 3).map((item) => (
                <Link
                  ...
                  className="card block hover:border-forest-200 transition-colors"
                >
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/credentials" className="text-forest-600 hover:text-forest-700 text-sm font-medium flex items-center gap-1">
