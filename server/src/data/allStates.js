export const stateLicenses = [
  ...
  { type: 'state_license', code: 'LCPC', name: 'Licensed Clinical Professional Counselor', state: 'ID', issuingBody: 'Idaho Licensing Board', renewalCycle: 12, totalCEUsRequired: 20, requirements: [{ category: 'Ethics', hoursRequired: 3 }, { category: 'General', hoursRequired: 17 }] },
