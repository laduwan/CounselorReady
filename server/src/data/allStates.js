export const stateLicenses = [
  ...
  { type: 'state_license', code: 'LMHC', name: 'Licensed Mental Health Counselor', state: 'FL', issuingBody: 'Florida Board of Clinical Social Work, MFT, and MHC', renewalCycle: 24, totalCEUsRequired: 30, requirements: [{ category: 'Ethics', hoursRequired: 3 }, { category: 'Domestic Violence', hoursRequired: 2 }, { category: 'Medical Errors', hoursRequired: 2 }, { category: 'General', hoursRequired: 23 }] },
  { type: 'state_license', code: 'LPC', name: 'Licensed Professional Counselor', state: 'GA', issuingBody: 'Georgia Composite Board', renewalCycle: 24, totalCEUsRequired: 35, requirements: [{ category: 'Ethics', hoursRequired: 5 }, { category: 'General', hoursRequired: 30 }] },
  ...
  { type: 'state_license', code: 'LPC', name: 'Licensed Professional Counselor', state: 'ID', issuingBody: 'Idaho Licensing Board', renewalCycle: 12, totalCEUsRequired: 20, requirements: [{ category: 'Ethics', hoursRequired: 3 }, { category: 'General', hoursRequired: 17 }] },
  ...
  { type: 'state_license', code: 'LPC', name: 'Licensed Professional Counselor', state: 'TX', issuingBody: 'Texas BHEC', renewalCycle: 24, totalCEUsRequired: 24, requirements: [{ category: 'Ethics', hoursRequired: 3 }, { category: 'General', hoursRequired: 21 }] },
...
export const specialtyCerts = [
  { type: 'specialty_cert', code: 'BC-TMH', name: 'Board Certified-TeleMental Health Provider', issuingBody: 'CCE', renewalCycle: 24, totalCEUsRequired: 20, requirements: [{ category: 'Telehealth', hoursRequired: 20 }] },
