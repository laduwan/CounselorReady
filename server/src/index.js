...
import adminCourseReviewsRoutes from './routes/adminCourseReviews.js';
...
import webhooksDailyRoutes from './routes/webhooksDaily.js';
...
app.use('/api/webhooks/daily', express.raw({ type: 'application/json' }));
...
app.use('/api/webhooks/daily', webhooksDailyRoutes);
