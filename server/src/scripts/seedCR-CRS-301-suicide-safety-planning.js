...
<p>Over the next three contact hours, this course will guide you through four integrated domains of practice. First, you will learn the epidemiology and the assessment frameworks that allow you to recognize and stratify risk, including the Columbia Suicide Severity Rating Scale{{callout:c-ssrs}}, one of the most widely used and well-validated tools in the field. Second, you will master the Stanley-Brown Safety Planning Intervention, a brief, collaborative, evidence-supported protocol that has been shown to reduce suicidal behavior and increase treatment engagement. Third, you will study lethal means counseling&mdash;the practice of helping clients and families reduce access to the methods most likely to be lethal during a crisis. Finally, you will examine the unique needs of special populations and the often-overlooked dimension of clinician self-care.</p>
...
<p>Thorough documentation is not bureaucratic busywork&mdash;it is a clinical and ethical obligation, a tool for continuity of care, and your most important protection in the event of an adverse outcome.{{alert:document}} The maxim &ldquo;if it wasn&rsquo;t documented, it wasn&rsquo;t done&rdquo; is especially true in suicide care, where a tragic outcome may later be scrutinized by licensing boards, attorneys, and your own conscience.</p>
...
<p>The SPI is built on a stepped logic that mirrors how a suicidal crisis unfolds and escalates. The plan begins with strategies the client can use entirely on their own and progresses toward strategies requiring more external support, culminating in professional and emergency resources, and finally the critical step of making the environment safer by reducing access to lethal means. The ordering is deliberate: a person in crisis should be able to start at the top of the plan and move down only as needed, escalating support in proportion to the intensity of the crisis. The six steps are: (1) recognizing warning signs, (2) internal coping strategies, (3) social contacts and settings that provide distraction, (4) people the client can ask for help, (5) professionals and agencies to contact during a crisis, and (6) making the environment safe.{{alert:protocol}} Each step is developed collaboratively, in the client&rsquo;s own words, with the clinician&rsquo;s role being to draw out and refine the client&rsquo;s own ideas rather than to prescribe generic strategies.</p>
