/**
 * remediateUnpaidTelementalCert.cjs
 *
 ...
 * To actually apply:  CONFIRM=yes node src/scripts/remediateUnpaidTelementalCert.cjs
 *
...
(async () => {
  ...
  if (!CONFIRM) {
    ...
    console.log('To apply: CONFIRM=yes node src/scripts/remediateUnpaidTelementalCert.cjs');
    return done();
  }
