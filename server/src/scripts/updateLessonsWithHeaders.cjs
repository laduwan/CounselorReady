// updateLessonsWithHeaders.cjs
// Run: node src/scripts/updateLessonsWithHeaders.cjs
// 
// Updates all lessons with:
// - Header images from Cloudflare R2
// - Shortened intros (2-3 sentences)
// - Visual separators
// - Engagement elements (matching, fill-in-blank, fun facts, knowledge checks)
...
const CDN_BASE = 'https://pub-43240822204b488d9038a7250ae71473.r2.dev/course-headers/headers';

// ============================================
// LESSON CONTENT WITH HEADERS & ENGAGEMENT
// ============================================
...
<img src="${CDN_BASE}/existential-header.png" alt="Existential Therapy Case Study" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #4A5568; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#4A5568,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#FFF5F5 0%,#FED7E2 100%); border:1px solid #FC8181; border-radius:10px; padding:20px; margin:25px 0;">
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Knowledge Check: Match the Ultimate Concern</h4>
<p>Match each client statement to the ultimate concern it represents:</p>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Client Statement</th><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Ultimate Concern</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. "No one really understands what I'm going through."</td><td style="border:1px solid #CBD5E0; padding:12px;">A. Death</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. "I could have done anything—why did I choose this?"</td><td style="border:1px solid #CBD5E0; padding:12px;">B. Freedom</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. "Dad's heart attack made me realize I'm wasting time."</td><td style="border:1px solid #CBD5E0; padding:12px;">C. Isolation</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">4. "What's the point of any of this?"</td><td style="border:1px solid #CBD5E0; padding:12px;">D. Meaninglessness</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#4A5568; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-C (Isolation), 2-B (Freedom), 3-A (Death), 4-D (Meaninglessness)</p>
</details>
</div>
...
<div style="background:linear-gradient(135deg,#F0FFF4 0%,#C6F6D5 100%); border:2px solid #68D391; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#276749;">📝 Fill in the Blank</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#276749; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">Neurotic = <strong>avoidance</strong>-based | Existential = <strong>growth</strong>-oriented</p>
</details>
</div>
...
<div style="background:linear-gradient(135deg,#FFFAF0 0%,#FEEBC8 100%); border:2px solid #ED8936; border-radius:10px; padding:25px; margin:30px 0;">
<h4 style="margin-top:0; color:#C05621;">🔑 Key Takeaway</h4>
...
<img src="${CDN_BASE}/billing-cycle-header.png" alt="The Billing Cycle" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #2B6CB0; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#2B6CB0,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Quick Quiz: Place of Service Codes</h4>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Setting</th><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">POS Code</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. Office</td><td style="border:1px solid #CBD5E0; padding:12px;">A. 02</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. Telehealth (patient at home)</td><td style="border:1px solid #CBD5E0; padding:12px;">B. 10</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. Client's home (in-person)</td><td style="border:1px solid #CBD5E0; padding:12px;">C. 11</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">4. Telehealth (patient at clinic)</td><td style="border:1px solid #CBD5E0; padding:12px;">D. 12</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-C (11=Office), 2-A (02=Telehealth-Home), 3-D (12=Home), 4-B (10=Telehealth-Clinic)</p>
</details>
</div>
...
<div style="background:linear-gradient(135deg,#F0FFF4 0%,#C6F6D5 100%); border:2px solid #68D391; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#276749;">📝 Fill in the Blank: KPI Targets</h4>
<ul>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#276749; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">AR: <strong>35</strong> days | Clean Claims: <strong>95</strong>% | Denials: under <strong>5</strong>% | Collections: <strong>95</strong>%</p>
</details>
</div>
...
<img src="${CDN_BASE}/credentialing-header.png" alt="Provider Credentialing" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #2C7A7B; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#2C7A7B,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Match the Credentialing Timeline</h4>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Payer Type</th><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Timeline</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. Medicare</td><td style="border:1px solid #CBD5E0; padding:12px;">A. 60-180 days</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. Medicaid</td><td style="border:1px solid #CBD5E0; padding:12px;">B. 60-90 days</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. Commercial</td><td style="border:1px solid #CBD5E0; padding:12px;">C. 90-120 days</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-B (Medicare: 60-90), 2-C (Medicaid: 90-120), 3-A (Commercial: 60-180)</p>
</details>
</div>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#276749; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answer</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">You must <strong>attest</strong> every <strong>3</strong> months (quarterly).</p>
</details>
</div>
...
<img src="${CDN_BASE}/icd10-header.png" alt="ICD-10 Coding" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #6B46C1; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#6B46C1,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Quick Quiz: Decode the Diagnosis</h4>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">ICD-10 Code</th><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Diagnosis</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. F32.1</td><td style="border:1px solid #CBD5E0; padding:12px;">A. Generalized anxiety disorder</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. F41.1</td><td style="border:1px solid #CBD5E0; padding:12px;">B. PTSD, unspecified</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. F43.10</td><td style="border:1px solid #CBD5E0; padding:12px;">C. MDD, single episode, moderate</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">4. F43.23</td><td style="border:1px solid #CBD5E0; padding:12px;">D. Adjustment disorder w/ mixed anxiety & depression</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-C, 2-A, 3-B, 4-D</p>
</details>
</div>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#276749; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answer</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">ICD-10 updates are effective <strong>October</strong> 1st.</p>
</details>
</div>
...
<img src="${CDN_BASE}/clearinghouse-header.png" alt="Clearinghouse Operations" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #D69E2E; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#D69E2E,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Match the Report Type</h4>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Report</th><th style="border:1px solid #CBD5E0; padding:12px; text-align:left; background:rgba(255,255,255,0.5);">Purpose</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. Claim Status</td><td style="border:1px solid #CBD5E0; padding:12px;">A. Claims outstanding too long</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. Rejection</td><td style="border:1px solid #CBD5E0; padding:12px;">B. Where each claim stands</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. Aging</td><td style="border:1px solid #CBD5E0; padding:12px;">C. Failed scrubbing with error codes</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">4. Payer Performance</td><td style="border:1px solid #CBD5E0; padding:12px;">D. Payment speed and denial rates</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-B, 2-C, 3-A, 4-D</p>
</details>
</div>
...
<img src="${CDN_BASE}/audit-header.png" alt="Audit Preparation" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #C53030; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#C53030,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 True or False</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-False (only send what's requested), 2-False (never alter/create documentation), 3-True, 4-True</p>
</details>
</div>
...
<img src="${CDN_BASE}/copays-header.png" alt="Client Payments" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #38A169; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#38A169,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Scenario Check</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answer</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;"><strong>$150</strong> — The deductible isn't met yet ($1,000 remaining), so client pays the full allowed amount until deductible is satisfied.</p>
</details>
</div>
...
<img src="${CDN_BASE}/rule135-header.png" alt="Georgia Rule 135" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #DD6B20; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#DD6B20,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Compliance Check</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">Required: <strong>1, 3, 5</strong> | NOT required: 2 (recording), 4 (audio-only permitted under certain conditions)</p>
</details>
</div>
...
<img src="${CDN_BASE}/ethics-header.png" alt="Ethical Decision Making" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #805AD5; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#805AD5,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Ethical Dilemma</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Explore</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;"><strong>Autonomy</strong> (client's right to choose their space) vs. <strong>Nonmaleficence</strong> (safety concerns—what if crisis occurs in public?) vs. <strong>Beneficence</strong> (is this the best care option?). Document the discussion and client's reasoning.</p>
</details>
</div>
...
<img src="${CDN_BASE}/appropriateness-header.png" alt="Clinical Appropriateness" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #319795; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#319795,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#FFF5F5 0%,#FED7E2 100%); border:1px solid #FC8181; border-radius:10px; padding:20px; margin:25px 0;">
<span style="font-size:24px; margin-right:10px;">💡</span>
<strong>Did You Know?</strong> Research shows telehealth is equally effective as in-person therapy for mild-moderate depression and anxiety. However, clients with active suicidal ideation show better outcomes with in-person care.
</div>
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Decision Matrix Practice</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-GREEN, 2-YELLOW (enhanced safety planning), 3-RED (needs in-person/higher level of care), 4-GREEN (headphones address privacy)</p>
</details>
</div>
...
<img src="${CDN_BASE}/platform-header.png" alt="Platform Setup" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #3182CE; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#3182CE,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; background:#EDF2F7;">Platform</th><th style="border:1px solid #CBD5E0; padding:12px; background:#EDF2F7;">Cost</th><th style="border:1px solid #CBD5E0; padding:12px; background:#EDF2F7;">Key Feature</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">Doxy.me</td><td style="border:1px solid #CBD5E0; padding:12px;">Free - $35/mo</td><td style="border:1px solid #CBD5E0; padding:12px;">No download, browser-based</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">SimplePractice</td><td style="border:1px solid #CBD5E0; padding:12px;">$69-99/mo</td><td style="border:1px solid #CBD5E0; padding:12px;">Integrated with EHR</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">Zoom Healthcare</td><td style="border:1px solid #CBD5E0; padding:12px;">$200+/yr</td><td style="border:1px solid #CBD5E0; padding:12px;">Robust features, reliable</td></tr>
</table>

<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Setup Checklist</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">Required: <strong>1, 3</strong> | Recommended but not required: 5 | Not required: 2, 4</p>
</details>
</div>
...
<img src="${CDN_BASE}/crisis-header.png" alt="Crisis Protocols" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #E53E3E; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#E53E3E,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Crisis Response by Risk Level</h4>
<p>Match the risk level to the appropriate response:</p>
<table style="width:100%; border-collapse:collapse; margin:15px 0;">
<tr><th style="border:1px solid #CBD5E0; padding:12px; background:rgba(255,255,255,0.5);">Risk Level</th><th style="border:1px solid #CBD5E0; padding:12px; background:rgba(255,255,255,0.5);">Response</th></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">1. LOW (ideation, no plan)</td><td style="border:1px solid #CBD5E0; padding:12px;">A. DO NOT END SESSION, call 911, stay on video</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">2. MODERATE (vague plan)</td><td style="border:1px solid #CBD5E0; padding:12px;">B. Safety planning, increase session frequency</td></tr>
<tr><td style="border:1px solid #CBD5E0; padding:12px;">3. HIGH (specific plan, means)</td><td style="border:1px solid #CBD5E0; padding:12px;">C. Don't end until safe, engage support person, secure means</td></tr>
</table>
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">1-B, 2-C, 3-A</p>
</details>
</div>
...
<img src="${CDN_BASE}/cultural-header.png" alt="Culturally Responsive Practice" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #D53F8C; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#D53F8C,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Self-Reflection</h4>
...
<img src="${CDN_BASE}/sustainable-header.png" alt="Sustainable Practice" style="width:100%; border-radius:12px; margin-bottom:30px;" />

<div class="lesson-intro" style="background:linear-gradient(to right,#f7fafc,#edf2f7); border-left:4px solid #48BB78; padding:20px 25px; margin-bottom:25px; border-radius:0 8px 8px 0;">
<h3 style="margin-top:0; color:#2D3748;">Why This Matters</h3>
...
<hr style="border:none; height:3px; background:linear-gradient(to right,#E2E8F0,#48BB78,#E2E8F0); margin:30px 0; border-radius:2px;" />
...
<div style="background:linear-gradient(135deg,#EBF8FF 0%,#BEE3F8 100%); border:2px solid #63B3ED; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#2B6CB0;">🎯 Burnout Prevention Quiz</h4>
...
<details style="margin-top:15px; cursor:pointer;">
<summary style="background:#2B6CB0; color:white; padding:10px 20px; border-radius:5px; font-weight:bold;">Click to Reveal Answers</summary>
<p style="background:#F7FAFC; padding:15px; border-radius:5px; margin-top:10px; border:1px solid #E2E8F0;">Helpful: <strong>2, 4, 5</strong> | Harmful: 1 (contributes to fatigue), 3 (blurs boundaries)</p>
</details>
</div>
...
<div style="background:linear-gradient(135deg,#F0FFF4 0%,#C6F6D5 100%); border:2px solid #68D391; border-radius:10px; padding:25px; margin:25px 0;">
<h4 style="margin-top:0; color:#276749;">📝 Create Your Plan</h4>
<ul>
...
async function updateLessons() {
  console.log('Starting lesson updates with headers & engagement...\n');
  ...
  console.log('   - Header images from R2 CDN');
  console.log('   - Shortened intros (2-3 sentences)');
  console.log('   - Visual separators');
  console.log('   - Fun facts 💡');
  console.log('   - Knowledge checks 🎯');
