    ...
    },
    {
      ...
      "contentBlocks": [
        ...
        },
        {
          ...
          "resources": [
            {
              "title": "Adult Attachment Interview (AAI) — Overview and Clinical Application",
              "type": "article",
              "url": "https://pubmed.ncbi.nlm.nih.gov/2788410/",
              "description": "Main & Goldwyn's foundational description of the Adult Attachment Interview. Background reading for clinicians seeking to understand the empirical basis for attachment classification in adults."
            },
            {
              "title": "Emotionally Focused Therapy for Couples — EFT-C Stage Summary",
              "type": "guide",
              "url": "",
              "description": "A clinical quick reference for the three stages and nine steps of EFT-C (Johnson, 2004). Includes stage goals, therapist interventions, and common stuck points for each stage."
            },
            {
              "title": "Attachment Style Self-Assessment — Clinical Conversation Starter",
              "type": "worksheet",
              "url": "",
              "description": "A brief, validated self-report instrument for use in psychoeducation and case conceptualization conversations. NOT a diagnostic tool — for use as a structured starting point for attachment-informed clinical dialogue with clients."
            },
            {
              "title": "Mentalization-Based Treatment (MBT) — Core Techniques Reference",
              "type": "guide",
              "url": "",
              "description": "Clinical quick reference for the core MBT techniques: stop-rewind-explore, the mentalizing stance, emotion validation, and affect focus. Based on Bateman & Fonagy (2016)."
            },
            {
              "title": "Experiences in Close Relationships Scale — Revised (ECR-R)",
              "type": "link",
              "url": "https://labs.psychology.illinois.edu/~rcfraley/measures/ecrr.htm",
              "description": "The ECR-R, a widely validated 36-item adult attachment measure (Fraley et al., 2000). Freely available for clinical and research use. Assesses attachment anxiety and avoidance dimensions."
            },
            {
              "title": "The Pursuit of Secure Attachment — Psychoeducation Handout for Clients",
              "type": "worksheet",
              "url": "",
              "description": "A one-page client handout explaining attachment patterns in plain language, the concept of earned security, and how therapy can support movement toward more secure relating. Suitable for sharing at the introduction of attachment-informed treatment."
            },
            {
              "title": "Fonagy et al. (2002) — Affect Regulation, Mentalization, and the Development of the Self",
              "type": "book",
              "url": "",
              "description": "The foundational text establishing the theoretical relationship between attachment, mentalization, and self-development. Key reference for clinicians practicing MBT or attachment-informed therapy."
            },
            {
              "title": "Johnson, S. M. (2019). Attachment Theory in Practice: EFT with Individuals, Couples, and Families.",
              "type": "book",
              "url": "",
              "description": "Susan Johnson's clinical integration of attachment theory with EFT practice across modalities. Highly recommended for clinicians translating the attachment framework into session-level interventions."
            }
          ]
        }
      ]
