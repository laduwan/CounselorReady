...
<p>The C-SSRS also separately assesses suicidal behavior (actual attempts, interrupted attempts, aborted attempts, and preparatory actions), which provides critical information about escalating risk trajectory. A client who has made preparatory actions (giving away prized possessions, researching specific methods, or acquiring the means to carry out a plan) represents elevated acute risk even if their currently stated ideation level appears relatively low on the scale.</p>
<p><strong>Means restriction counseling:</strong> Assessment of access to lethal means is a mandatory component of suicide risk assessment. Firearms are involved in more than half of all suicide deaths in the United States and represent by far the highest lethality method available. When firearms are present in the home of a client with suicidal ideation, clinicians should directly discuss means restriction — whether temporarily removing the firearm from the home, transferring it to a trusted individual for secure storage outside the home, or implementing a trigger lock or gun safe — as part of the safety planning conversation. Counseling on lethal means restriction is a well-validated, evidence-based suicide prevention intervention that should be offered routinely, discussed without judgment, and documented in the clinical record regardless of whether the client agrees to implement it.</p>
