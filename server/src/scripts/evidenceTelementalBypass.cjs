/**
 * evidenceTelementalBypass.cjs  —  READ ONLY. No writes.
 *
 ...
 *
 *   node src/scripts/evidenceTelementalBypass.cjs
 *   EMAIL="aterry@gmail.com" node src/scripts/evidenceTelementalBypass.cjs
 */
