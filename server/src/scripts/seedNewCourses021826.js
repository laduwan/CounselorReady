...
**Concurrent treatment** implements trauma-focused therapy and anxiety treatment in parallel, typically in separate sessions or with different providers. For example, a client might attend weekly trauma-focused therapy with one clinician and participate in an anxiety management group with another clinician. This approach is appropriate when both trauma and anxiety symptoms require urgent attention, when the client has sufficient resou</p><h2>Conflict of Interest Disclosure</h2><p>The course developer and author, GA Integrated Therapeutic Perspectives LLC, have no relevant financial or non-financial conflicts of interest to disclose. No commercial support was received.</p><h2>Grievance and Complaint Procedure</h2><p>Participants with concerns may contact info@counselorready.com. Unresolved complaints may be submitted to NBCC at nbcc.org.</p><h2>Accessibility Statement</h2><p>We are committed to equitable access. Participants requiring accommodations should contact info@counselorready.com prior to enrollment.</p>`,
        order: 1,
        duration: 30
      }]
    }
