...
const COURSE = {
  ...
  ceHours: 3, ceuHours: 3, credits: 3, ceuEligible: true,
  category: 'clinical', ceCategory: 'Clinical',
  ...
  approvals: [{ body: 'NBCC', providerNumber: '7760', providerName: 'GA Integrated Therapeutic Perspectives LLC', status: 'approved', hourBreakdown: [{ label: 'core', hours: 3 }], deliveryFormat: 'asynchronous' }],
  nbccContentAreas: ['Addiction Counseling'],
  presenter: { name: 'Kejuiana Johnson', credentials: 'MA, LPC, NCC, CPCS, BC-TMH', degree: 'MA', licenseNumber: 'LPC009587', licenseState: 'Georgia', licenseType: 'LPC', qualificationStatement: 'Kejuiana Johnson, MA, LPC, NCC, CPCS, BC-TMH, is a licensed professional counselor and approved clinical supervisor in Georgia with extensive experience in addiction counseling, co-occurring disorder treatment, and integrated behavioral health care.' },
  instructor: 'GA Integrated Therapeutic Perspectives LLC',
  author: 'Kejuiana Johnson, MA, LPC, NCC, CPCS, BC-TMH',
  accessType: 'subscription', price: 49.99, pricingTier: 'standard',
  ...
  targetAudience: ['Licensed mental health professionals (LPCs, LCSWs, LMFTs, NCCs) seeking to build competency in integrated assessment and treatment for clients with co-occurring substance use and mental health disorders.'],
  tags: ['co-occurring disorders', 'substance use', 'integrated treatment', 'dual diagnosis', 'IDDT', 'motivational interviewing', 'addiction', 'mental health'],
  objectives: [
...
<p>Upon completing this course and passing the assessment, you will be awarded 3 CE hours approved by NBCC through GA Integrated Therapeutic Perspectives LLC, ACEP #7760.</p>`
        ...
        {
          type: 'keyTakeaway', order: 2, title: 'Learning Objectives',
          takeaways: [
            'Describe the prevalence of co-occurring disorders using current SAMHSA NSDUH epidemiological data and explain the shared vulnerability model versus the self-medication hypothesis.',
            'Differentiate substance-induced mental health symptoms from independent psychiatric disorders and apply DSM-5-TR criteria to common co-occurring presentations.',
    ...
    // ===================================================================
    // SECTION 1 — Epidemiology and Models
    // ===================================================================
    {
...
<p>Several additional theoretical frameworks contribute to the COD picture. The <strong>sensitization model</strong> proposes that repeated substance use lowers the threshold for psychiatric symptoms through neurobiological sensitization: alcohol that initially reduces anxiety eventually produces rebound anxiety between uses, ultimately generating an anxiety disorder where none existed before. The <strong>common factor model</strong> emphasizes shared environmental risk factors, particularly trauma, poverty, and social marginalization, that drive COD through social pathways rather than primarily biological ones. Each of these models has treatment implications, and a clinician who is familiar with all of them can select interventions that address the mechanisms most relevant to a given client's presentation.</p>`
        ...
        },
        {
          ...
          image: '', imageAlt: 'Four-quadrant diagram showing COD service intensity matrix with psychiatric severity on Y axis and substance use severity on X axis', imagePosition: 'right'
        },
        {
          ...
          options: [
            { text: 'Approximately 7%', isCorrect: true },
            { text: 'Approximately 25%', isCorrect: false },
            { text: 'Approximately 45%', isCorrect: false },
...
<p>The integrated model is not without its challenges. It requires expanded clinical competency, which demands ongoing training and supervision. It can create role strain for clinicians who trained in one specialty. It requires systems that are often not yet built in many communities. But the alternative — knowingly delivering a treatment modality that produces demonstrably worse outcomes for a majority of behavioral health clients — is not a defensible option. The evidence for integration is as strong as the evidence for any intervention in behavioral health, and the ethical mandate for counselors is clear: provide or facilitate integrated care for clients with COD.</p>`
        },
        {
          ...
          flashcards: [
            { front: 'Co-occurring disorder (COD)', back: 'The simultaneous presence of one or more substance use disorders and one or more mental health disorders in the same individual; often called "dual diagnosis."' },
            { front: 'Self-medication hypothesis', back: 'The theory that individuals use substances to manage underlying psychiatric symptoms; generates the clinical question "what need does this substance meet?"' },
            { front: 'Shared vulnerability model', back: 'The theory that both SUD and mental health disorders arise from overlapping genetic, neurobiological, and environmental risk factors rather than one causing the other.' },
            { front: 'SAMHSA Quadrant Model', back: 'A triage framework organizing COD service intensity by the relative severity of the psychiatric and substance use dimensions, from Quadrant I (low/low) to Quadrant IV (high/high).' },
            { front: 'Sequential treatment model', back: 'Treating one disorder first then the other; historically the dominant approach but consistently outperformed by integrated treatment.' },
            { front: 'Integrated treatment model', back: 'Addressing both SUD and mental health disorders simultaneously in the same clinical relationship or coordinated team; the evidence-based standard of care for COD.' },
            { front: 'Sensitization model', back: 'The theory that repeated substance use lowers the threshold for psychiatric symptoms through neurobiological sensitization — e.g., alcohol initially reducing anxiety eventually generating an anxiety disorder.' }
          ]
        },
        {
          ...
          options: [
            { text: 'Better treatment retention', isCorrect: true },
            { text: 'Greater reduction in substance use', isCorrect: true },
            { text: 'Improved psychiatric symptom outcomes', isCorrect: true },
            { text: 'Reduced risk of psychiatric hospitalization', isCorrect: true },
            { text: 'Identical outcomes to parallel treatment when providers communicate regularly', isCorrect: false }
          ],
        ...
        {
          type: 'keyTakeaway', order: 12, title: 'Key Takeaways — Section 1',
          takeaways: [
...
<p>The <strong>PCL-5 (PTSD Checklist for DSM-5)</strong> is a 20-item self-report measure of PTSD symptoms corresponding to the four DSM-5 symptom clusters (intrusion, avoidance, negative cognitions and mood, and hyperarousal/reactivity). A cutoff of 33 or above is commonly used for probable PTSD, though the optimal cutoff varies by population. In COD assessment, the PCL-5 is critically important because PTSD is one of the most common co-occurring disorders with SUD, and is frequently missed or misattributed to personality features or substance use consequences. Many clients with PTSD-SUD COD have never had their trauma history systematically assessed.</p>`
        ...
        {
          type: 'callout', order: 3, calloutType: 'warning',
...
<p>Motivational interviewing (MI) occupies a unique position in COD assessment: it is simultaneously an assessment strategy and a therapeutic intervention. The MI assessment roll, a structured component of early MI engagement, invites the client to tell their own story about their substance use and mental health, with the counselor listening for the client's own ambivalence, their self-assessment of problems and benefits, and the meaning they attach to their use. This approach gathers critical assessment data — the client's stage of change, their perceived barriers to addressing either condition, their values and goals — while simultaneously building the collaborative therapeutic relationship that is foundational to COD engagement. The functional analysis of substance use, discussed next, makes the MI assessment framework explicit.</p>`
        ...
        },
        {
          ...
          image: '', imageAlt: 'A cyclical diagram showing psychiatric symptoms leading to substance use leading to short-term relief leading to worsened symptoms completing the cycle', imagePosition: 'left'
        },
        {
          ...
          options: [
            { text: 'Part 2 requires patient-specific written consent to share SUD records with the patient\'s own psychiatrist for treatment coordination', isCorrect: true },
            { text: 'Part 2 prohibits re-disclosure by recipients who receive Part 2-protected information', isCorrect: true },
            { text: 'Part 2 and HIPAA both permit disclosure for treatment coordination without patient authorization', isCorrect: false },
            { text: 'Violations of 42 CFR Part 2 can carry criminal penalties', isCorrect: true },
            { text: 'Part 2 applies only to inpatient substance use treatment programs', isCorrect: false }
          ],
        ...
        },
        {
          ...
          nodes: {
            start: {
              ...
              choices: [
                { text: 'Focus the assessment on depression since that is the referral reason; note the AUDIT-C result as secondary', nextId: 'focus_depression' },
                { text: 'Explore the AUDIT-C result with curiosity and without alarm, integrating alcohol questions into the broader assessment', nextId: 'explore_alcohol' },
                { text: 'Inform Marcelline that you need to assess her alcohol use thoroughly before treating her depression', nextId: 'sequential_approach' }
              ]
            },
            focus_depression: {
              ...
              choices: [
                { text: 'Reflect: What might you have done at intake to catch this earlier?', nextId: 'reflection_node' }
              ]
            },
            explore_alcohol: {
              ...
              choices: [
                { text: 'How would you integrate these findings into a COD assessment summary?', nextId: 'integration_node' }
              ]
            },
            sequential_approach: {
              ...
              choices: [
                { text: 'What would a more integrative framing look like?', nextId: 'explore_alcohol' }
              ]
            },
            integration_node: {
        ...
        },
        {
          ...
          matchingPairs: [
            { term: 'AUDIT-C', definition: 'Three-item screen for hazardous or harmful alcohol use; sensitive for problematic drinking before dependence onset.' },
            { term: 'DAST-10', definition: 'Ten-item self-report screen for drug-related problems across substances, without specifying which drug.' },
            { term: 'PCL-5', definition: 'Twenty-item PTSD severity screen aligned with DSM-5 four-cluster model; critical for COD clients with trauma history.' },
            { term: 'MINI', definition: 'Structured clinician-administered diagnostic interview covering 17 DSM-5 disorders including both psychiatric and SUD diagnoses.' },
            { term: 'PHQ-9', definition: 'Nine-item depression severity screen with Item 9 serving as a suicidality flag; cannot distinguish substance-induced from independent depression.' }
          ]
        },
        {
        ...
        {
          type: 'keyTakeaway', order: 11, title: 'Key Takeaways — Section 2',
          takeaways: [
    ...
    // ===================================================================
    // SECTION 3 — Integrated Treatment Interventions
    // ===================================================================
    {
      title: 'Integrated Treatment Interventions',
      contentBlocks: [
        {
          type: 'sectionDivider', sectionNumber: '3',
          title: 'Integrated Treatment Interventions',
...
<p>The counselor's role in MAT is not prescriptive but is nonetheless clinical: psychosocial support significantly improves MAT outcomes, and counselors provide the relapse prevention, coping skills, and motivational work that medication alone cannot accomplish. A counselor who views MAT as "not my lane" and declines to engage with the medication dimension of a COD client's treatment is providing incomplete integrated care. Key knowledge areas include the difference between physical dependence (a physiological adaptation to a medication, expected and clinically managed) and addiction (a disorder of compulsive use despite negative consequences, not implied by physical dependence), and the evidence that MAT medications do not constitute "trading one drug for another" — a myth that, when endorsed by mental health providers, undermines MAT adherence and worsens outcomes.</p>`
        ...
        },
        {
          ...
          image: '', imageAlt: 'A visual representation of cultural factors — community, family, history, language, and spirituality — surrounding a COD treatment framework', imagePosition: 'right'
        },
        {
          type: 'cardSort', order: 7,
          ...
          categories: ['Motivational Interviewing Technique', 'CBT Adaptation for COD'],
          cards: [
            { id: '1', text: 'Exploring the pros and cons of changing substance use from the client\'s perspective without imposing the clinician\'s view', correctCategory: 'Motivational Interviewing Technique' },
            { id: '2', text: 'Completing a thought record that includes a column connecting distorted cognitions to substance use triggers', correctCategory: 'CBT Adaptation for COD' },
            { id: '3', text: 'Using a double-sided reflection to hold the client\'s ambivalence: "On one hand... and on the other hand..."', correctCategory: 'Motivational Interviewing Technique' },
            { id: '4', text: 'Behavioral activation scheduling that explicitly replaces times previously devoted to substance use with rewarding alternative activities', correctCategory: 'CBT Adaptation for COD' },
            { id: '5', text: 'Affirmations that identify the client\'s strengths and resilience without praise that centers the clinician', correctCategory: 'Motivational Interviewing Technique' },
            { id: '6', text: 'Graded exposure hierarchy for anxiety that includes substance use cues at intermediate rungs', correctCategory: 'CBT Adaptation for COD' },
            { id: '7', text: 'Eliciting change talk by asking the client what worries them most about continuing current substance use', correctCategory: 'Motivational Interviewing Technique' },
            { id: '8', text: 'Relapse prevention planning that maps psychiatric symptom escalation as a high-risk situation for substance use', correctCategory: 'CBT Adaptation for COD' }
          ]
        },
        {
          type: 'fillInBlank', order: 8,
          question: 'In the IDDT model, the four stages of integrated treatment are: ________, persuasion, active treatment, and ________.',
          blanks: ['engagement', 'relapse prevention'],
        ...
        {
          type: 'keyTakeaway', order: 10, title: 'Key Takeaways — Section 3',
          takeaways: [
    ...
    questions: [
      {
        ...
        options: [
          { text: '5.2 million', isCorrect: false },
          { text: '12.0 million', isCorrect: false },
          { text: '21.5 million', isCorrect: true },
          { text: '37.0 million', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Substance use disorders and mental health disorders share overlapping genetic and neurobiological risk factors', isCorrect: false },
          { text: 'Individuals use specific substances to manage or alleviate pre-existing psychiatric symptoms', isCorrect: true },
          { text: 'Repeated substance use lowers the threshold for psychiatric symptoms through neurobiological sensitization', isCorrect: false },
          { text: 'Social marginalization and poverty drive both SUDs and mental illness through shared environmental pathways', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'A high AUDIT-C score indicates the depression is substance-induced; psychiatric treatment should be deferred until sobriety is established', isCorrect: false },
          { text: 'Because the conditions are bidirectional, the temporal relationship cannot be determined and treatment should be integrated regardless', isCorrect: false },
          { text: 'Reassess psychiatric symptoms after 4–6 weeks of reduced or abstinent alcohol use; symptoms persisting at that point are more consistent with an independent disorder', isCorrect: true },
          { text: 'DSM-5-TR prohibits diagnosing MDD in the context of active alcohol use disorder', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Quadrant I (low severity on both dimensions) — primary care or lower-intensity outpatient', isCorrect: false },
          { text: 'Quadrant II (high psychiatric severity, low SUD severity) — mental health specialty with SUD monitoring', isCorrect: true },
          { text: 'Quadrant III (high SUD severity, low psychiatric severity) — addiction specialty with psychiatric monitoring', isCorrect: false },
          { text: 'Quadrant IV (high severity on both dimensions) — intensive integrated services', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'A confirmed diagnosis of alcohol use disorder', isCorrect: false },
          { text: 'The need for a formal structured diagnostic interview only; no clinical follow-up otherwise', isCorrect: false },
          { text: 'Probable hazardous or harmful alcohol use warranting further clinical assessment', isCorrect: true },
          { text: 'That the client should be immediately referred to an addiction specialist before mental health treatment proceeds', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Sharing SUD records with a state health department for public health surveillance', isCorrect: false },
          { text: 'Sharing SUD information with the client\'s psychiatrist for treatment coordination', isCorrect: true },
          { text: 'Sharing SUD records with a CARF audit team conducting an accreditation review', isCorrect: false },
          { text: 'Reporting the client\'s positive drug screen to their employer', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'Active CBT skills training and relapse prevention planning', isCorrect: false },
          { text: 'Building a therapeutic relationship and meeting practical needs before addressing substance use directly', isCorrect: false },
          { text: 'The client being engaged in treatment but ambivalent about changing their substance use', isCorrect: true },
          { text: 'The client having achieved sustained recovery and working to consolidate gains', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Recommend that the client discontinue buprenorphine before anxiety treatment can begin', isCorrect: false },
          { text: 'Decline to address the opioid use disorder dimension and refer exclusively to the prescribing physician', isCorrect: false },
          { text: 'Provide psychosocial support, relapse prevention, and anxiety-focused CBT alongside MAT coordination with the prescriber', isCorrect: true },
          { text: 'Advise the client that buprenorphine is itself an addictive drug and explore non-medication alternatives', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Integration: addressing both conditions in the same clinical relationship or team', isCorrect: true },
          { text: 'Stage-wise treatment: matching interventions to the client\'s current stage of motivation', isCorrect: true },
          { text: 'Abstinence as a precondition for psychiatric treatment', isCorrect: false },
          { text: 'Assertive outreach: meeting clients where they are rather than waiting for them to engage', isCorrect: true },
          { text: 'Long-term perspective: understanding COD recovery as a years-long process with predictable setbacks', isCorrect: true },
          { text: 'Harm reduction as an explicit treatment component', isCorrect: true }
        ],
      ...
      },
      {
        ...
        options: [
          { text: 'A score of 10 or above indicates moderate-to-severe depression warranting clinical attention', isCorrect: true },
          { text: 'Item 9 (suicidality) always requires clinical follow-up when endorsed', isCorrect: true },
          { text: 'The PHQ-9 can reliably distinguish substance-induced depressive disorder from independent MDD', isCorrect: false },
          { text: 'The PHQ-9 is available in multiple languages and free to use', isCorrect: true },
          { text: 'A PHQ-9 score is sufficient to diagnose major depressive disorder without further clinical interview', isCorrect: false }
        ],
      ...
      },
      {
        ...
        options: [
          { text: 'Thought records that include a column connecting distorted cognitions to alcohol use triggers', isCorrect: true },
          { text: 'Behavioral activation scheduling that explicitly replaces time previously devoted to drinking', isCorrect: true },
          { text: 'Requiring abstinence before introducing any cognitive restructuring', isCorrect: false },
          { text: 'Integrated relapse prevention that identifies depressive episodes as high-risk situations for alcohol use', isCorrect: true },
          { text: 'Coping skills training framed explicitly as alternatives to alcohol for managing depressive symptoms', isCorrect: true }
        ],
      ...
      },
      {
        ...
        options: [
          { text: '"The cocaine is clearly a problem we need to address right away. Have you considered inpatient treatment?"', isCorrect: false },
          { text: '"It sounds like the cocaine is doing something really important for you — it helps you manage the memories in a way nothing else has. And I also hear that part of you knows this comes at a cost."', isCorrect: true },
          { text: '"I understand you feel that way, but research shows cocaine makes PTSD worse in the long run."', isCorrect: false },
          { text: '"Let\'s set a goal to reduce your cocaine use by 50% this week and then we\'ll discuss the PTSD."', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'Shared vulnerability model only — cannabis and anxiety share genetic risk factors but do not interact causally', isCorrect: false },
          { text: 'Self-medication hypothesis only — cannabis reduces anxiety through CB1 receptor activation and is therefore a rational adaptation', isCorrect: false },
          { text: 'Bidirectional sensitization: low-dose THC may reduce anxiety acutely while high-dose and chronic use downregulate CB1 receptors, increasing baseline anxiety and generating withdrawal anxiety', isCorrect: true },
          { text: 'Sequential model — cannabis use always precedes anxiety disorder onset and is therefore the primary diagnosis', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Motivation, ambivalence, and readiness to change', isCorrect: false },
          { text: 'Antecedents, behaviors, and consequences', isCorrect: true },
          { text: 'Screening score, diagnostic criteria, and treatment history', isCorrect: false },
          { text: 'Biological, psychological, and social risk factors', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'Using a single screening instrument that is not validated for the population being assessed', isCorrect: false },
          { text: 'One set of symptoms capturing the clinician\'s attention while the other co-occurring condition is systematically missed', isCorrect: true },
          { text: 'The tendency for clients to underreport substance use because of stigma', isCorrect: false },
          { text: 'Misattributing substance withdrawal symptoms to a psychiatric disorder', isCorrect: false }
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          { text: 'Discharge the client for non-compliance and offer to re-engage when they are ready', isCorrect: false },
          { text: 'Send a formal termination letter and document unsuccessful treatment', isCorrect: false },
          { text: 'Assertive outreach — contact the client through home visits or preferred communication to maintain engagement without conditions', isCorrect: true },
          { text: 'Require that the client demonstrate two consecutive weeks of sobriety before services resume', isCorrect: false }
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          { text: 'Comply with the subpoena immediately, as court orders always supersede 42 CFR Part 2', isCorrect: false },
          { text: 'Refuse disclosure and notify the client, then seek legal counsel and respond under the specific procedural requirements for court orders under 42 CFR Part 2', isCorrect: true },
          { text: 'Disclose only with the client\'s verbal consent given at the time of the court order', isCorrect: false },
          { text: 'Contact SAMHSA directly for authorization before responding', isCorrect: false }
        ],
        correctAnswer: 1,
...
function countWords(obj) {
  const text = JSON.stringify(obj).replace(/<[^>]+>/g, ' ').replace(/[^a-zA-Z\s]/g, ' ');
...
function validate(course) {
  ...
  if (!course.sections || course.sections.length < 2) errors.push('Fewer than 2 sections');
  if (!course.assessment || !course.assessment.questions || course.assessment.questions.length < 15) errors.push('Fewer than 15 assessment questions');
  if (!course.references || course.references.length < 15) errors.push('Fewer than 15 references');

  const hasResources = course.sections.some(s => s.contentBlocks && s.contentBlocks.some(b => b.type === 'resources'));
  if (!hasResources) errors.push('No inline resources block found');

  course.sections.forEach((section, si) => {
    if (!section.contentBlocks) return;
    section.contentBlocks.forEach((block, bi) => {
      if (block.type === 'reflection' && block.prompt && !block.question) {
        errors.push(`Section ${si} block ${bi}: reflection uses "prompt" instead of "question"`);
      }
      if (block.type === 'keyTakeaway' && (!block.takeaways || !Array.isArray(block.takeaways))) {
        errors.push(`Section ${si} block ${bi}: keyTakeaway missing takeaways array`);
      }
      if (block.type === 'flashcardDeck' && (!block.flashcards || !Array.isArray(block.flashcards))) {
        errors.push(`Section ${si} block ${bi}: flashcardDeck missing flashcards array`);
      }
      if (block.type === 'cardSort' && (!block.cards || !block.categories)) {
        errors.push(`Section ${si} block ${bi}: cardSort missing cards or categories`);
      }
      if (block.type === 'scenarioTree' && (!block.nodes || !block.startNode)) {
        errors.push(`Section ${si} block ${bi}: scenarioTree missing nodes or startNode`);
      }
    });
  });
...
async function main() {
  ...
  if (wordCount < 18000) {
    console.warn(`⚠️  Word count ${wordCount} is below the 18,000-word minimum.`);
  } else {
    console.log(`✅ Word count meets the 18,000-word minimum.`);
  }
  ...
  if (errors.length > 0) {
    ...
    if (!process.env.DRY_RUN) process.exit(1);
  } else {
  ...
  if (existing) {
    await InteractiveCourse.updateOne({ slug: SLUG }, { $set: COURSE });
    console.log(`✅ Updated existing course: ${SLUG}`);
  } else {
    await InteractiveCourse.create(COURSE);
    console.log(`✅ Created new course: ${SLUG}`);
  }
