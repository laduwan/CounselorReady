...
<p><strong>The corrective recapitulation of the primary family group</strong> is visible in the assignment of roles that members did not consciously choose: one member becomes the group's designated peacemaker, interrupting every conflict before it develops; another becomes the group's designated challenger, voicing the disagreement everyone else is avoiding. These roles are frequently isomorphic with the member's position in their family of origin. The facilitator who has tracked a member's family history in intake can name the parallel directly when the pattern repeats in session, which converts an unconscious repetition into conscious, examinable material.</p>
...
<p>Mandatory reporting obligations in group therapy present a specific complication that does not arise in individual treatment: a member may disclose reportable content—child abuse, elder abuse, or information that triggers a <strong>duty to warn</strong>—that concerns a third party who is not the disclosing member and, in some cases, is not even a client of the practice. The clinician's mandatory reporting obligation is triggered by the content of the disclosure, not by whose case file it happens to appear in, so the fact that the concerning content was disclosed by Member A about Member A's own child, spouse, or associate does not change the clinician's duty; the report must still be made according to the jurisdiction's mandatory reporting statute.</p>
